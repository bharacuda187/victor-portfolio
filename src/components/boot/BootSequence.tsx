  ...
  return (
    <>
      <motion.main
        ...
        className={`fixed inset-0 z-[999] flex items-center justify-center overflow-hidden bg-black text-white transition-none ${
          bootComplete ? 'pointer-events-none' : 'pointer-events-auto'
        }`}
      >
        {/* =====================================================
BACKGROUND GRID
===================================================== */}
        ...
        <div className="relative z-20 min-h-[520px] w-full max-w-5xl px-8 sm:min-h-[540px]">
          {/* TOP SYSTEM BAR */}
            ...
            {systemChecks.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`ml-auto text-orange-500 transition-opacity ${
